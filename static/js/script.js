document.addEventListener('DOMContentLoaded', function () {
    ...
    // texto. Las imágenes están guardadas en la carpeta "static/img/" del
    // proyecto Flask (fotos reales de cada producto). Componentes PC no tiene
    ...
    const catalogoProductos = [
        {
            ...
            disponible: true,
            items: [
                { nombre: 'HP Pavilion 15', imagen: '/static/img/laptop-hp-pavilion-15.webp' },
                { nombre: 'Lenovo IdeaPad 3', imagen: '/static/img/lenovo-ideapad.jpg' },
                { nombre: 'Dell Inspiron 15', imagen: '/static/img/dell-inspiron.jpg' },
                { nombre: 'ASUS VivoBook', imagen: '/static/img/asus-vivobook.webp' }
            ]
        },
        {
            ...
            disponible: true,
            items: [
                { nombre: 'Samsung Galaxy A55', imagen: '/static/img/samsung-galaxy.jpg' },
                { nombre: 'iPhone 15', imagen: '/static/img/iphone-15.jpg' },
                { nombre: 'Xiaomi Redmi Note 13', imagen: '/static/img/redmi-note.jpg' },
                { nombre: 'Motorola Edge 50', imagen: '/static/img/motorola-edge.webp' }
            ]
        },
        {
            ...
            disponible: true,
            items: [
                { nombre: 'Mouse Redragon', imagen: '/static/img/mouse-redragon.jpg' },
                { nombre: 'Teclado Mecánico', imagen: '/static/img/teclado-mecanico.png' },
                { nombre: 'Audífonos HyperX', imagen: '/static/img/audifonos-hyperx.jpg' },
                { nombre: 'Mouse Pad RGB', imagen: '/static/img/mousepad.png' }
            ]
        },
        {
